...
const TicketCard = ({ ticket }) => {
  ...
  return (
    <div className="flex flex-col bg-pink-light hover:bg-white transition-all duration-300 border border-pink-dark text-pink-dark rounded-2xl shadow-md p-4 m-3 font-fancy">
